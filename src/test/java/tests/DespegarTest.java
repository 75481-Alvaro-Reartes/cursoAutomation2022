...
public class DespegarTest {
  ...
  public void validaBsuquedaAlojamientoDespegar() throws Exception{
	 ...
	 WebElement searchInputOrigen = driver.findElement(By.cssSelector("div.input-container>input[placeholder='Ingresá una ciudad, alojamiento o punto de interés']"));
	  ...
	  searchInputOrigen.sendKeys("Mendoza, Mendoza, Argentina");
	  Thread.sleep(1000);
	  ...
	  fechaDesde.click();
	  Thread.sleep(2000);
	  WebElement fechaDesdeSeleccionado = driver.findElement(By.xpath("//div[@class='sbox5-floating-tooltip sbox5-floating-tooltip-opened']//div[@class='sbox5-monthgrid'][@data-month='2022-02']//div[@class='sbox5-monthgrid-datenumber-number'][text() = '26']"));
	  ...
	  fechaHasta.click();
	  Thread.sleep(2000);
	  WebElement fechaHastaSeleccionado = driver.findElement(By.xpath("//div[@class='sbox5-floating-tooltip sbox5-floating-tooltip-opened']//div[@class='sbox5-monthgrid'][@data-month='2022-02']//div[@class='sbox5-monthgrid-datenumber-number'][text() = '28']"));
